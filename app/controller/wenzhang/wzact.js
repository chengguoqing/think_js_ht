...
module.exports = class extends Base {
    indexAction() {
        ...
        return _asyncToGenerator(function* () {
            ...
            var sd_der = "";
            if (date_s.type == 1) {
                sd_der = yield _this.add_action('article', date_s, {
                    title: date_s.title
                });
            } else if (date_s.type == 2) {
                sd_der = yield _this.xg_action('article', date_s);
            } else if (date_s.type == 3) {
                sd_der = yield _this.get_action('article', date_s);
            } else if (date_s.type == 4) {
                sd_der = yield _this.del_action('article', date_s);
            }
