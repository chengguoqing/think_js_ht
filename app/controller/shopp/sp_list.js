...
module.exports = class extends Base {
    indexAction() {
        ...
        return _asyncToGenerator(function* () {
            ...
            var sd_der = "";
            if (date_s.type == 1) {
                sd_der = yield _this.add_action('spxq', date_s, {
                    name: date_s.name
                });
            } else if (date_s.type == 2) {
                sd_der = yield _this.xg_action('spxq', date_s);
            } else if (date_s.type == 3) {
                sd_der = yield _this.get_action('spxq', date_s);
                try {
                    sd_der.spt = sd_der.spt.split(",");
                } catch (e) {}
            } else if (date_s.type == 4) {
                sd_der = yield _this.del_action('spxq', date_s);
            }
...
//# sourceMappingURL=sp_list.js.map