...
module.exports = class extends Base {
    indexAction() {
        ...
        return _asyncToGenerator(function* () {
            ...
            var sd_der = "";
            if (date_s.type == 1) {
                sd_der = yield _this.add_action('dpxx', date_s, {
                    name: date_s.name
                });
            } else if (date_s.type == 2) {
                sd_der = yield _this.xg_action('dpxx', date_s);
            } else if (date_s.type == 3) {
                sd_der = yield _this.get_action('dpxx', date_s);
            } else if (date_s.type == 4) {
                sd_der = yield _this.del_action('dpxx', date_s);
            }
